...
var User = /** @class */ (function () {
    function User(id, name, email, isAdmin) {
        this.id = id;
        this.name = name;
        this.email = email;
...
function createUser(newUser) {
    return "User ".concat(newUser.name, " created successfully");
}
var user1 = new User(2022, "Razan", "Razan@gmail.com", true);
var user2 = new User(2023, "Ali", "Ali@example.com");
...
var product1 = new Product("iPhone 16", 3000, "Phone");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    data = _a.sent();
                    return [2 /*return*/, data.map(function (user) { return ({
                            id: user.id,
                            name: user.name,
                            email: user.email
                        }); })];
